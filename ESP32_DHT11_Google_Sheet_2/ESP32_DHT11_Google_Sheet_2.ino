...
// กำหนด Line Token
#define LINE_TOKEN "eksj6vkXZaHDwVLWMZbLfWriWG9jesdzWmrEXg5Pnlr"
...
String GAS_ID = "AKfycbzt7420S8pT19MGDRBfa4lEvmU4Xoip7pvlxMyLTumF7HyrEoDKJ0Dd0qKOeP_1Ce7VSg"; // apps script ID or deployment ID
...
void loop() {
  ...
  if (now - lastMeasure > 3000) {
    ...
    String humidityString = "ความชื้นเกินกำหนด : " + String(h);
    LINE.notify(humidityString);

    String tmp = "อุณหภูมิ : " + String(t);
    LINE.notify(tmp);
